...
(function() {
	...
	Mistify.prototype.appendMasks = function() {
		...
		var maskDom = '' +
			'<div class="mistify__mask-container">' +
				'<div class="mistify__mask mistify__mask--active"><img src="images/overlay/mistCarousel-1.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="images/overlay/mistCarousel-2.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="images/overlay/mistCarousel-3.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="images/overlay/mistCarousel-4.png" alt="Mask"/></div>' +
			'</div>';
	...
	Mistify.prototype.preloadMasks = function() {
		...
		var masks = ['images/overlay/mistCarousel-1.png', 'images/overlay/mistCarousel-2.png', 'images/overlay/mistCarousel-3.png', 'images/overlay/mistCarousel-4.png']
