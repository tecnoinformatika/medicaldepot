...
$.fn.inlineStyle = function(e) {
        ...
        _setup_portfolioinfiniteitemsloader: function() {
            var e = this.options,
                t = this;
            $(e.nextSelector).on('click',function(e) {
...
! function(e) {
    ...
    SEMICOLON.initialize = {
        ...
        goToTop: function() {
            ...
            t || (t = 700), a || (a = "easeOutQuad"), W.on('click',function() {
        ...
        menufunctions: function() {
            ...
            }), SEMICOLON.isMobile.Windows() && (e().superfish ? e("#primary-menu > ul, #primary-menu > div > ul,.top-links > ul").superfish("destroy").addClass("windows-mobile-menu") : (e("#primary-menu > ul, #primary-menu > div > ul,.top-links > ul").addClass("windows-mobile-menu"), console.log("menufunctions: Superfish not defined.")), e("#primary-menu ul li:has(ul)").append('<a href="#" class="wn-submenu-trigger"><i class="icon-angle-down"></i></a>'), e("#primary-menu ul li.sub-menu").children("a.wn-submenu-trigger").on('click',function(t) {
        ...
        sideHeader: function() {
            e("#header-trigger").on('click',function() {
        ...
        onePageScroll: function() {
            if (x.length > 0) {
                ...
                t || (t = 1e3), s || (s = "easeOutQuad"), x.find("a[data-href]").on('click',function() {
                    var n = e(this),
                        o = n.attr("data-href"),
                        r = n.attr("data-speed"),
        ...
        topsearch: function() {
            e(document).on("click", function(t) {
                e(t.target).closest("#top-search").length || a.toggleClass("top-search-open", !1), e(t.target).closest("#top-cart").length || A.toggleClass("top-cart-open", !1), e(t.target).closest("#page-menu").length || S.toggleClass("pagemenu-active", !1), e(t.target).closest("#side-panel").length || a.toggleClass("side-panel-open", !1), e(t.target).closest("#primary-menu.mobile-menu-off-canvas > ul").length || e("#primary-menu.mobile-menu-off-canvas > ul").toggleClass("show", !1), e(t.target).closest("#primary-menu.mobile-menu-off-canvas > div > ul").length || e("#primary-menu.mobile-menu-off-canvas > div > ul").toggleClass("show", !1)
            }), e("#top-search-trigger").on('click',function(t) {
                a.toggleClass("top-search-open"), A.toggleClass("top-cart-open", !1), e("#primary-menu > ul, #primary-menu > div > ul").toggleClass("show", !1), S.toggleClass("pagemenu-active", !1), a.hasClass("top-search-open") && _.find("input").focus(), t.stopPropagation(), t.preventDefault()
            })
        },
        topcart: function() {
            e("#top-cart-trigger").on('click',function(e) {
                S.toggleClass("pagemenu-active", !1), A.toggleClass("top-cart-open"), e.stopPropagation(), e.preventDefault()
            })
        }
    }, SEMICOLON.slider = {
        init: function() {
        ...
        filterInit: function() {
            return e().isotope ? F.length < 1 ? !0 : F.hasClass("customjs") ? !0 : void F.each(function() {
                ...
                i || (i = "activeFilter"), t.find("a").on('click',function() {
        ...
        shuffleInit: function() {
            return e().isotope ? e(".portfolio-shuffle").length < 1 ? !0 : void e(".portfolio-shuffle").on('click',function() {
                var t = e(this),
                    a = t.attr("data-container");
                e(a).isotope("shuffle")
        ...
        ajaxload: function() {
            e(".portfolio-ajax .portfolio-item a.center-icon").on('click',function(t) {
            ...
            t.length > 0 && t.each(function() {
                ...
                a || (a = "slide"), i && "swing" != i || (i = "swing", g = !0), s || (s = "horizontal"), n = "true" == n ? !0 : !1, o = o ? !1 : !0, r || (r = 5e3), l || (l = 600), d || (d = !1), m = "false" == m ? !1 : !0, "vertical" == s && (m = !1), c = "false" == c ? !1 : !0, c = "true" == h ? "thumbnails" : c, u = "false" == u ? !1 : !0, f = "false" == f ? !1 : !0, p = "false" == p ? !1 : !0, t.flexslider({
                    ...
                    start: function(t) {
                        ...
                        SEMICOLON.initialize.lightbox(), e(".flex-prev").html('<i class="fa fa-angle-left"></i>'), e(".flex-next").html('<i class="fa fa-angle-right"></i>'), SEMICOLON.portfolio.portfolioDescMargin()
                    },
                    after: function() {
        ...
        toggles: function() {
            ...
            t.length > 0 && t.each(function() {
                var t = e(this),
                    a = t.attr("data-state");
                "open" != a ? t.children(".togglec").hide() : t.children(".togglet").addClass("toggleta"), t.children(".togglet").on('click',function() {
        ...
        accordions: function() {
            ...
            t.length > 0 && t.each(function() {
                var t = e(this),
                    a = t.attr("data-state"),
                    i = t.attr("data-active");
                i ? i -= 1 : i = 0, t.find(".acc_content").hide(), "closed" != a && t.find(".acctitle:eq(" + Number(i) + ")").addClass("acctitlec").next().show(), t.find(".acctitle").on('click',function() {
        ...
        navTree: function() {
            ...
            t.length > 0 && t.each(function() {
                ...
                }) : t.find("ul li:has(ul) > a").on('click',function(s) {
                    var n = e(this);
        ...
        carousel: function() {
            ...
            return t.length < 1 ? !0 : void t.each(function() {
                ...
                h || (h = !1), f || (f = !1), m = "false" == m ? !1 : !0, p = "false" == p ? !1 : !0, b = "true" == b ? !0 : !1, C = "true" == C ? !0 : !1, w = "true" == w ? !0 : !1, S = "true" == S ? !0 : !1, x = "true" == x ? !0 : !1, N = "true" == N || a.hasClass("rtl") ? !0 : !1, t.owlCarousel({
                    margin: Number(g),
                    loop: d,
        ...
        linkScroll: function() {
            e("a[data-scrollto]").on('click',function() {
                var t = e(this),
        ...
        extras: function() {
            ...
            }), e("#primary-menu-trigger,#overlay-menu-close").on('click',function() {
            ...
            }), e("#page-submenu-trigger").on('click',function() {
                return a.toggleClass("top-search-open", !1), S.toggleClass("pagemenu-active"), !1
            }), S.find("nav").on('click',function(e) {
